...
;
    ...
    "canvas": {
        "name": "Canvas",
        "description": "Detects support for the canvas element for 2D drawing."
    },
    "canvastext": {
        "name": "Canvas text",
    ...
    "customevent": {
        "name": "CustomEvent",
        "description": "Detects support for CustomEvent."
    },
    "dart": {
        "name": "Dart",
    ...
    "eventlistener": {
        "name": "Event Listener",
        "description": "Detects native support for addEventListener"
    },
    "exiforientation": {
        "name": "EXIF Orientation",
    ...
    "queryselector": {
        "name": "QuerySelector",
        "description": "Detects support for querySelector."
    },
    "quotamanagement": {
        "name": "Quota Storage Management API",
    ...
    "bgrepeatspace": {
        ...
        "description": "Detects the ability to use space as property for background-repeat"
    },
    "bgrepeatround": {
        "name": "Background Repeat Round",
        "description": "Detects the ability to use round as property for background-repeat"
    },
    "backgroundsize": {
        "name": "Background Size",
        "description": ""
    ...
    "inlinesvg": {
        "name": "Inline SVG",
        "description": "Detects support for inline SVG in HTML (not within XHTML)."
    },
    "smil": {
        "name": "SVG SMIL animation",
